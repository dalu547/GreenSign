...
class MyWebView extends StatefulWidget {
  ...
  MyWebView(this.envelope_id);

  String web_url = "";

  @override
  _MyWebViewState createState() => _MyWebViewState(envelope_id);
}

Future<void> getStringFromSharedPreferences(String envelope_id) async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
  String? stringValue =
      prefs.getString('loginUser'); // Replace 'key' with your preference key
  if (stringValue != null) {
...
class _MyWebViewState extends State<MyWebView> {
  ...
  _MyWebViewState(this.envelope_id);

  @override
  void initState() {
    super.initState();

    getStringFromSharedPreferences(envelope_id);
  }
    ...
    return Scaffold(
      ...
      body: InAppWebView(
        initialUrlRequest: URLRequest(
          ...
          url: Uri.parse(""), // Replace with your web page URL
        ),
        ...
        onWebViewCreated: (InAppWebViewController controller) {
          ...
          webViewController?.evaluateJavascript(
              source: "console.log('WebView created');");

          final envelope_id =
              "654c896de29b874270e10541"; // Replace with the actual user ID
        ...
        onLoadStop: (controller, url) async {
          ...
          await controller?.evaluateJavascript(
              source: "console.log('Test JavaScript Bridge');");
